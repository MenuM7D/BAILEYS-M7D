# <div align='center'>BAILEYS-M7D - Typescript/Javascript WhatsApp Web API</div>

<div align="center">

<img src="https://i.postimg.cc/6qq8tgrg/file.jpg" alt="Header Image" width="100%"/>

<br/>

<!-- Badges -->
<p>
  <img src="https://img.shields.io/github/v/release/MenuM7D/BAILEYS-M7D?include_prereleases&sort=semver" alt="Latest Release"/>
  <img src="https://img.shields.io/github/languages/code-size/MenuM7D/BAILEYS-M7D" alt="Code Size"/>
  <img src="https://img.shields.io/github/license/MenuM7D/BAILEYS-M7D" alt="License"/>
  <img src="https://img.shields.io/github/stars/MenuM7D/BAILEYS-M7D" alt="Stars"/>
  <img src="https://img.shields.io/github/forks/MenuM7D/BAILEYS-M7D" alt="Forks"/>
</p>

<!-- GitHub Stats -->
<p>
  <img src="https://github-readme-stats.vercel.app/api?username=M7D-DEV&show_icons=true&theme=radical" alt="GitHub Stats"/>
</p>
...
This library is a modified version maintained by **M7D-DEV** and is in no way affiliated with or endorsed by WhatsApp. Use at your own discretion. Do not spam people with this. We discourage any stalkerware, bulk or automated messaging usage. 

#### Liability and License Notice
BAILEYS-M7D and its maintainers cannot be held liable for misuse of this application, as stated in the [MIT license](https://github.com/MenuM7D/BAILEYS-M7D/blob/main/LICENSE).
The maintainers of BAILEYS-M7D do not in any way condone the use of this application in practices that violate the Terms of Service of WhatsApp. The maintainers of this application call upon the personal responsibility of its users to use this application in a fair way, as it is intended to be used.
##
...
> [!IMPORTANT]
> This is a modified and maintained version by **M7D-DEV**.
> For support and updates, please visit the official repository.
...
- [GitHub Repository](https://github.com/MenuM7D/BAILEYS-M7D)
...
```ts
import makeWASocket, { useSingleFileAuthState, useMongoFileAuthState } from '@whiskeysockets/baileys'
...
const connectAuth = async() => {
  ...
  const collection = client.db("m7d-baileys").collection("sessions")
  return collection
}
...
const logger = pino({ timestamp: () => `,"time":"${new Date().toJSON()}"` }).child({ class: "M7D-BAILEYS" })
logger.level = "fatal"
       ...
       interactiveButtons: [ 
          { 
             ...
             buttonParamsJson: JSON.stringify({ 
                ...
                additional_note: 'M7D-DEV Kawaii >\\\<', 
...
await sock.sendMessage(
    ...
    { 
        album: [{
        	image: {
        		url: 'https://example.com/m7d-dev.jpg'
        	}, 
        	caption: 'Hay'
        }, {
        	image: Buffer, 
        	...
        	video: {
        		url: 'https://example.com/m7d-dev.mp4'
        	}, 
        	caption: 'Hay'
        }, {
        	video: Buffer, 
